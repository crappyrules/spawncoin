...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 25751; // SPWN
        ...
        const unsigned EMISSION_SPEED_FACTOR = 20;  // similar to Bitcoin emission speed
        ...
        const uint64_t MAX_OUTPUT_SIZE_CLIENT = 10'000'000'00000000;
    ...
    const char CRYPTONOTE_NAME[] = "Spawn";
