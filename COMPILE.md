...
-   `cd ..`
-   `git clone https://github.com/spawncoin/spawncoin/`
-   `mkdir -p spawncoin/build`
-   `cd spawncoin/build`
-   `cmake3 ..`
-   `make`
...
-   `MSBuild Spawncoin.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild Spawncoin.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`
...
[^ Return To Top](#compiling-spawncoin)
